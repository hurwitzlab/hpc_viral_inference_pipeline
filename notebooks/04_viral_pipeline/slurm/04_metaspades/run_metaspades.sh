#! /bin/bash
# This script submits a job array on a SLURM scheduler to run metaSpades on cleaned reads
# --------------------------------------------------
...
export JOB1="04_metaspades"  # this is not necessary but will be useful for consistency in larger pipelines
