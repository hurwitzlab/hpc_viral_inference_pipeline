#! /bin/bash
# This script submits a job array on a SLURM scheduler to run VirSorter2 on assembled contig files.
# --------------------------------------------------
...
export JOB1="05_virsorter2"  # this is not necessary but will be useful for consistency in larger pipelines
