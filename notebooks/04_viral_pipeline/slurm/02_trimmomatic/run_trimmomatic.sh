#! /bin/bash
# This script submits a job array on a SLURM scheduler to run Trimmomatic on raw reads
...
export JOB1="02_trimmomatic"  # this is not necessary but will be useful for consistency in larger pipelines
