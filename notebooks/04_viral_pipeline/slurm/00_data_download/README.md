# 00: Data Download
=================
This directory contains the script to download SRA data using `prefetch` from the SRA Toolkit within an Apptainer container.
...
This step doesn't involve the job scheduler (SLURM or otherwise) — it runs directly on the login node — so the script is identical regardless of which scheduler you use for the rest of the pipeline.
