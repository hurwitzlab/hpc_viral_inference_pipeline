#! /bin/bash
# This script submits a job array on a SLURM scheduler to run Prokka for viral protein annotation.
# --------------------------------------------------
...
export JOB1="07_prokka"  # this is not necessary but will be useful for consistency in larger pipelines
