#! /bin/bash
# This script submits a job array on a SLURM scheduler to run DRAM-v for viral genome annotation.
# --------------------------------------------------
...
export JOB1="08_dramv"  # this is not necessary but will be useful for consistency in larger pipelines
